...
async function tryCheckoutSpecialAlbumId() {
    console.log("album.js: tryCheckoutSpecialAlbumId");
    const overflow = 100;
...
async function tryCreateNewAlbum() {
    console.log("album.js: tryCreateNewAlbum");
    const d = new Date();
    const method = "POST";
...
async function createNewAlbumThenCheckoutSpecialAlbumId() {
    console.log("album.js: createNewAlbumThenCheckoutSpecialAlbumId");
...
export async function requestSpecialAlbumId(uid, forceCreateNewAlbum) {
    console.log("album.js: requestSpecialAlbumId");
